...
int main()
{
	...
	rsa.GetPairKey(P_QPAIR[bit_13][p],P_QPAIR[bit_13][q]);//获得最终的密钥对，P_QPAIR定义在RSA.h中，存放事先定义好的素数对，bit_13指最终产生12位私密
	printf("\np:%d, q:%d\n", P_QPAIR[bit_13][p],P_QPAIR[bit_13][q]);
